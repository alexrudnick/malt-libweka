 ...
 * @see NumericToBinary
 */
public class BinaryInfoGainAttributeEval extends ASEvaluation
    implements
      AttributeEvaluator,
      OptionHandler {
  ...
  /**
   * Initializes an information gain attribute evaluator. All non-class attributes must be binary.
   * 
  ...
  public void buildEvaluator(Instances data) throws Exception {
    ...
    for (int i = 0; i < data.numAttributes(); i++) {
      if (i != classIndex) {
        m_InfoGains[i] =
            (ContingencyTables.entropyOverColumns(counts[i]) - ContingencyTables
  ...
  /**
   * evaluates an individual attribute by measuring the amount of information gained about the class
   * given the attribute.
   * 
